...
public class FooDoNetSQLProvider extends ContentProvider {
    ...
    public static final Uri URI_INSERT_REGISTERED_FOR_PUBLICATION = Uri.parse("content://"+AUTHORITY+"/"+BASE_PATH + INSERT_REG);
    public static final Uri URI_DELETE_REGISTERED_FOR_PUBLICATION = Uri.parse("content://"+AUTHORITY+"/"+BASE_PATH + DELETE_REG);
